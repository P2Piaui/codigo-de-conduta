...
* [Regras de etiqueta - Discord](#regras-de-etiqueta---discord)
  * [Comandos](#comandos)
  * [Dúvidas](#dúvidas)
  ...
  * [Conhecendo o Discord](#conhecendo-o-discord)
  * [Sugestões e melhorias](#sugestões-e-melhorias)

## Código de Conduta

O **Discord P2P** deve ser um lugar seguro e convidativo para pessoas independentemente de:
...
Como membro deste Discord, você concorda que:
...
O desrespeito às regras desta comunidade, descritas nesse documento, acarretará em consequências. Para infrações pequenas, você talvez possa ser suspenso temporariamente do Discord. Em caso de reincidência, ou se a comunidade acreditar que você não está agindo de boa fé, você poderá ser banido permanentemente.

**Se você sofrer algum tipo de abuso, assédio, discriminação, ou se sentir inseguro (a), fale com um admin.
Essa é a lista de moderadores e seus respectivos IDs do Discord:**

* **Cândido Sales** - @candidosales
* **Daniel Alvarenga** - @AlvarengaDaniel
* **Marcos Marroquim** - @-

*A posição de admin é para fins de moderação imparcial, eles não vão moderar ou editar nada escrito no Discord, a menos que isso seja resultado de uma discussão e acordado entre todos.*
...
Dada a representatividade desta comunidade, os moderadores se reservam o direito de suspender ou banir do grupo membros que violem o presente Código de Conduta fora do Discord ou outros meios de comunicação da nossa comunidade, incluindo mas não se limitando a outros grupos do Slack, GitHub, redes sociais ou aplicativo de mensagens instantâneas.
...
[https://discordapp.com/channels/493225622210871296](https://discordapp.com/channels/493225622210871296)

## Regras de etiqueta - Discord

### Comandos

Muitos membros desse grupo usam o Discord durante o trabalho, ou o tem instalado no celular. Por isso, os comandos `@channel` e `@everyone` foram desabilitados para usuários normais, sendo utilizados somente pelos moderadores somente quando necessário.

Em caso de dúvida sobre como usar o Discord ou algum comando específico, procure um admin.
...
O Discord permite que qualquer membro crie novos canais. O P2P possui vários canais para discussões gerais ou específicas. O objetivo de ter diversos canais é permitir que membros com interesse em determinado assunto possam conversar de maneira mais focada, além de permitir que diversas conversas ocorram em paralelo. Antes de criar um canal, porém, verifique se há interesse de outros membros em participar do canal, se não existe um canal equivalente e se o foco do canal está de acordo com o propósito maior do P2P e com o presente Código de Conduta. A equipe de Admins se reserva o direito de fechar e arquivar canais em duplicidade ou inativos por longos períodos.
...
A equipe de Admins se reserva o direito de controlar a configuração de bots e integrações, não sendo permitido aos demais membros ativar novas configurações de bots ou integrações. Desta forma, protegemos o grupo da criação de integrações maliciosas ou com propósitos que divergem do P2P.

### Conhecendo o Discord
É novo no Discord? Não tem problema, o P2P é aberto à participação de todos. Quer tirar o máximo proveito da ferramenta? Tire um tempo para ler um pouco da [ajuda disponível](https://support.discordapp.com/hc/en-us/articles/219470277-Getting-Started), consulte os [atalhos disponíveis](https://support.discordapp.com/hc/en-us/search?utf8=%E2%9C%93&query=shortcut) ou tire sua dúvida sobre a ferramenta no [#random](https://discordapp.com/channels/493225622210871296/493232000338100255/).
